...
This repository includes a structured design package for **BEMS Edge AI Gateway**. The package captures the system boundary, runtime flow, hardware/software interfaces, validation strategy, and implementation roadmap.
