# BEMS Edge AI Gateway Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for BEMS Edge AI Gateway. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: C++ edge runtime coordinating BACnet polling, local safety rules, RabbitMQ command transport, and cloud-ready telemetry. | Scenario tests and documentation review. |
