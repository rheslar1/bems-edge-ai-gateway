# BEMS Edge AI Gateway Deep Architecture
...
C++17, CMake and CTest, BACnet/IP polling boundary, BEMS-ai recommendation boundary, RabbitMQ command-route model, Telemetry payload serialization, Local simulator fallback, Edge Linux / Yocto deployment path
...
- Test coverage: `tests/GatewayTests.cpp`
